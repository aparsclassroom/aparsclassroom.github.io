        ...
        if (free === true) {
          ...
          $(document).ready(function () {
            document.getElementById("navB").innerHTML = `
                                    ...
                                    <a class="navbar-brand" href="../../../Botany.html">
              ...
              .then((loadedData) => {
                ...
                $.each(a, function (a, e) {
                  (i1 += '<div class="col-md-15 well">'),
                    (i1 +=
                      "<h3 class='eng'>Word Number : " + e.Number + "</h3>"),
                    (i1 += "<h3>" + e.Word + "</h3>"),
                    (i1 += "<h4>অর্থ: " + e.Meaning + "</h4>"),
                    (i1 +=
                      "<a type='button' class='wh' title='Premium Content'> 🔒 ব্যাখ্যা </a>"),
                    (i1 += "</div>&nbsp;"),
                    m1 % 2 == 0 &&
                      (i1 += '</div><div class="card text-center">'),
                    m1++;
                }),
                  (i1 += "</div>"),
                  $("#all").html(i1);
            ...
            $("#txt-search").keyup(function () {
              ...
              if (
                ...
                document.getElementById("filter-records").innerHTML =
                  "<p style=" +
                  '"text-align: center;">এরূপ কোন শব্দ খুঁজে পাওয়া যায় নি 😶</p>';
              ...
              .then((loadedData) => {
                ...
                $.each(a, function (a, e) {
                  (i1 += '<div class="col-md-15 well">'),
                    ...
                    (i1 += "<h4>অর্থ: " + e.Meaning + "</h4>"),
                    (i1 +=
                      "<a type='button' class='links text-center' href=\"" +
                      e.ExplainMe +
                      '">' +
                      "ব্যাখ্যা" +
                      "</a>"),
...
function getBook() {
  ...
  for (var i = 0; i < bookmarks.length; i++) {
    ...
    bookmarksResults.innerHTML +=
      ...
      '"><h3 class="bangla">' +
      name +
      '</h3> <p class="bangla"> Id : ' +
      sl +
      '</p> <span class="bangla"> সময় : ' +
      time +
      "</span> </a><hr></div>";
  }
}
