                ...
                if (free === true) {
                    ...
                    $(document).ready(function() {
                        document.getElementById('navB').innerHTML = `
                                    ...
                                    <button type="button" class="btn" id="bk" style="position: right;" data-toggle="modal" data-target="#myModal"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="white" class="bi bi-bookmark-star-fill" viewBox="0 0 16 16">
