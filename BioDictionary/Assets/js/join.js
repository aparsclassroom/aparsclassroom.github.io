  ...
  firebase.auth().onAuthStateChanged(function (user) {
    if (user) {
      ...
      if (free === true) {
        ...
        const scriptURL =
          "https://script.google.com/macros/s/AKfycbzB3guHEtsQeS3jNx45Y-sEZIrVsq-Rca3ABCCr8UvruRKv3-CH2CRuTwHDyGz-9ziGqg/exec";
          ...
          .then((dashboard) => {
            if (dashboard.code != 200) {
              ...
              fetch("https://json.geoiplookup.io/")
                ...
                .catch(() => {
                  document.getElementById("ip-details").value =
                    "No Ip Address Found 💔";
                });
