window.addEventListener('load', function() {
    ...
    fetch(ln1 + ln + ln2 + "?q=Explain&Number=" + as4)
        .then((res) => {
            return res.json();
        })
        .then((loadedData) => {
            if (loadedData.code === 200) {
                ...
                var ref = a.Ref;
                var RefPage = a.RefPage;
                var meaning = a.Meaning;
                var description = a.Description;
                var img = a.img;
                var audio = a.Audio;
                var link = a.Return;
                document.title = a.Word + ' | BioDictionary';
    ...
    <path d="M2 15.5a.5.5 0 0 0 .74.439L8 13.069l5.26 2.87A.5.5 0 0 0 14 15.5V2a2 2 0 0 0-2-2H4a2 2 0 0 0-2 2v13.5zM8 4.41c1.387-1.425 4.854 1.07 0 4.277C3.146 5.48 6.613 2.986 8 4.412z"/>
            ...
            <div class="card bg-primary shadow-soft border-light px-4 py-1 mb-6">
                ...
                <div class="card-body text-md-left">
                    ...
                    <div id="bla" class="mb-3 lonng">
                        ...
                        <div style="margin-top:15px;padding:15px;padding-top:10px;border-radius:10px;" class="card bg-primary shadow-soft border-light px-4 mb-3">
            ...
            `;
                ...
                if (img == "" || img == "https://gdurl.com") {
                    ...
                    let width = "max-width:600px";
                    document.getElementById('image').style.display = "none";
                    document.getElementById('fi').style.display = "none";
                    document.getElementById('bla').classList.add('flu');
                    document.getElementById('cont').style.cssText = width;
                    p[0].style.cssText = width;
                    p[1].style.cssText = width;
                    p[2].style.cssText = width;
                    p[3].style.cssText = width;
                    p[4].style.cssText = width;
                } else {
