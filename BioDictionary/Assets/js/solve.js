                            ...
                            fetch('https://script.google.com/macros/s/AKfycbx2dj1PI7ROIp_8swqHiquG7ZeBriFNIMudGMvPBTy9o72F2cc07QUAJkDUAtOTxxcK/exec' + "?q=Exam&ID=" + ID)
                                ...
                                .then((loadedQuestions) => {
                                    if (loadedQuestions.code === 200) {
                                        ...
                                        <p style="color:green"><strong>সঠিক উত্তর : ${exam[0].answer}</strong></p>
                                        <hr>
                                        ...
                                        <p style="color:green"><strong>সঠিক উত্তর : ${exam[1].answer}</strong></p>
                                        <hr>
                                        ...
                                        <p style="color:green"><strong>সঠিক উত্তর : ${exam[2].answer}</strong></p>
                                        <hr>
                                        ...
                                        <p style="color:green"><strong>সঠিক উত্তর : ${exam[3].answer}</strong></p>
                                        <hr>
                                        ...
                                        <p style="color:green"><strong>সঠিক উত্তর : ${exam[4].answer}</strong></p>
                                        <hr>
                                        ...
                                        <p style="color:green"><strong>সঠিক উত্তর : ${exam[5].answer}</strong></p>
                                        <hr>
                                        ...
                                        <p style="color:green"><strong>সঠিক উত্তর : ${exam[6].answer}</strong></p>
                                        <hr>
                                        ...
                                        <p style="color:green"><strong>সঠিক উত্তর : ${exam[8].answer}</strong></p>
                                        <hr>
                                        ...
                                        <p style="color:green"><strong>সঠিক উত্তর : ${exam[9].answer}</strong></p>
                                        `;
                                    } else {
