                            ...
                            fetch('https://script.google.com/macros/s/AKfycbx2dj1PI7ROIp_8swqHiquG7ZeBriFNIMudGMvPBTy9o72F2cc07QUAJkDUAtOTxxcK/exec' + "?q=Exam&ID=" + ID)
                                ...
                                .then((loadedQuestions) => {
                                    if (loadedQuestions.code === 200) {
                                        ...
                                        <hr>
                                        <h3>প্রশ্ন ১৬. ${exam[15].question}</h3>
                                        <p>Option 1 : ${exam[15].choice1}</p>
                                        <p>Option 2 : ${exam[15].choice2}</p>
                                        <p>Option 3 : ${exam[15].choice3}</p>
                                        <p>Option 4 : ${exam[15].choice4}</p>
                                        <h3 style="color:green"><strong>সঠিক উত্তর : ${exam[15].answer}</strong></h3>
                                        <hr>
                                        <h3>প্রশ্ন ১৭. ${exam[16].question}</h3>
                                        <p>Option 1 : ${exam[16].choice1}</p>
                                        <p>Option 2 : ${exam[16].choice2}</p>
                                        <p>Option 3 : ${exam[16].choice3}</p>
                                        <p>Option 4 : ${exam[16].choice4}</p>
                                        <h3 style="color:green"><strong>সঠিক উত্তর : ${exam[16].answer}</strong></h3>
                                        <hr>
                                        <h3>প্রশ্ন ১৮. ${exam[17].question}</h3>
                                        <p>Option 1 : ${exam[17].choice1}</p>
                                        <p>Option 2 : ${exam[17].choice2}</p>
                                        <p>Option 3 : ${exam[17].choice3}</p>
                                        <p>Option 4 : ${exam[17].choice4}</p>
                                        <h3 style="color:green"><strong>সঠিক উত্তর : ${exam[17].answer}</strong></h3>
                                        <hr>
                                        <h3>প্রশ্ন ১৯. ${exam[18].question}</h3>
                                        <p>Option 1 : ${exam[18].choice1}</p>
                                        <p>Option 2 : ${exam[18].choice2}</p>
                                        <p>Option 3 : ${exam[18].choice3}</p>
                                        <p>Option 4 : ${exam[18].choice4}</p>
                                        <h3 style="color:green"><strong>সঠিক উত্তর : ${exam[18].answer}</strong></h3>
                                        <hr>
                                        <h3>প্রশ্ন ২০. ${exam[19].question}</h3>
                                        <p>Option 1 : ${exam[19].choice1}</p>
                                        <p>Option 2 : ${exam[19].choice2}</p>
                                        <p>Option 3 : ${exam[19].choice3}</p>
                                        <p>Option 4 : ${exam[19].choice4}</p>
                                        <h3 style="color:green"><strong>সঠিক উত্তর : ${exam[19].answer}</strong></h3>
                                        <hr>
                                        `;
                                    } else {
