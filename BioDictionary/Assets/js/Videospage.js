    ...
    if (user) {
      if (user.isAnonymous === true) {
        ...
        const ID =
          ...
          as.split("/")[4] +
          "/" +
          as.split("/")[6].split(".")[0].substring(0, 16);
        const epNo = as.split("/")[6].split(".")[0].substring(6, 16);
        fetch(
          "https://script.google.com/macros/s/AKfycbwmv686zGEWVt5MOKDk6JHbVlktZamUSNpPwgWEaBL4oqf5VyTDg-vK39rhFy7yeK59/exec?ID=" +
            ID,
        )
          .then((res) => {
            return res.json();
            ...
            if (loadedData.code === 200) {
              ...
              if (loadedData.Meta != "") {
                document.getElementById("advertisement").innerHTML =
                  "<h3 style='text-align:center'>" + loadedData.Meta + "</h3>";
              }
              document.title =
                "BioCast Ep." +
                epNo +
              ...
              document.getElementById("hed").innerText =
                "BioCast Episode " + epNo;
              const strt = "https://www.youtube.com/embed/";
              const ext =
                "?modestbranding=1&loop=0&controls=1&autoplay=1&mute=0&rel=0&color=red&vq=hd1080";
              $(".embed-responsive-item").attr(
                "src",
                strt + loadedData.Video_Id + ext,
              );
              document
                .getElementById("previewP")
                .setAttribute(
                  "src",
              ...
              document
                ...
                .setAttribute(
                  "onclick",
                  "window.open('https://drive.google.com/u/0/uc?id=" +
                    loadedData.Pdf_Id +
                    "&export=download')",
                );
              document.getElementById("Video_Description").innerText =
                loadedData.Video_Description;
              var s1l = "./" + loadedData.Suggestion_1 + ".html";
              var s1i =
                "https://i.ytimg.com/vi/" +
                loadedData.Suggestion_1_Link +
                "/hqdefault.jpg";
              ...
              document.getElementById("Instructor_Dp").src =
                loadedData.Instructor_Dp;
              document.getElementById("Instructor_Name").innerText =
                loadedData.Instructor_Name;
              document.getElementById("Instructor_Subject").innerText =
                loadedData.Instructor_Subject;
              document.getElementById("Instructor_Institute").innerText =
                loadedData.Instructor_Institute;
            } else {
