  ...
  (function (e, t) {
    ...
    var Ve =
      ...
      Qe = function (e) {
        return (
          b(Ye, e) ||
            (Le && b(Ge, e) ? (Ye[e] = Ge[e]) : (Ye[e] = Xe("Symbol." + e))),
          Ye[e]
        );
      },
      Je = { f: Qe },
      ...
      Lt = function (e, t) {
        ...
        return (
          mt(n, { type: ht, tag: e, description: t }),
          o || (n.description = t),
          n
        );
      },
      ...
      Rt = function (e, t, n) {
        ...
        return (
          ...
          b(Et, i)
            ? (n.enumerable
                ? (b(e, dt) && e[dt][i] && (e[dt][i] = !1),
                  (n = Ve(n, { enumerable: c(0, !1) })))
                : (b(e, dt) || kt(e, dt, c(1, {})), (e[dt][i] = !0)),
              jt(e, i, n))
            : kt(e, i, n)
        );
      },
      ...
      _t = function (e) {
        ...
        return (
          ...
          (!(n || !b(this, t) || !b(Et, t) || (b(this, dt) && this[dt][t])) ||
            n)
        );
      },
      Ut = function (e, t) {
        ...
        if (n !== vt || !b(Et, i) || b(At, i)) {
          var r = wt(n, i);
          return (
            !r || !b(Et, i) || (b(n, dt) && n[dt][i]) || (r.enumerable = !0), r
          );
        }
      },
      Dt = function (e) {
    ...
    if (
        ...
        (te(
          (yt = function () {
            ...
            var e =
              ...
              n = function (e) {
                this === vt && n.call(At, e),
                  b(this, dt) && b(this[dt], t) && (this[dt][t] = !1),
                  jt(this, t, c(1, e));
              };
      ...
      je({ global: !0, wrap: !0, forced: !Le, sham: !Le }, { Symbol: yt }),
      ft(_e(xt), function (e) {
        et(e);
      }),
      je(
        { target: ht, stat: !0, forced: !Le },
        {
          for: function (e) {
            var t = String(e);
    ...
    [].keys &&
      ("next" in (pn = [].keys())
        ? (hn = wn(wn(pn))) !== Object.prototype && (dn = hn)
        : (Tn = !0)),
      null == dn && (dn = {}),
      b(dn, kn) ||
        O(dn, kn, function () {
          ...
          [
            ...
            function (e, r) {
              ...
              for (var h = 0, p = 0, m = []; p < s.length; ) {
                f.lastIndex = er ? p : 0;
                var g,
                  v = qi(f, er ? s : s.slice(p));
                if (
                  null === v ||
                  (g = Ji(ce(f.lastIndex + (er ? 0 : p)), s.length)) === h
                )
                  p = Fi(s, p, c);
                else {
    ...
    var dr = Qe("iterator"),
          ...
          ? function (e, t) {
              for (
                ...
                for (
                  var c,
                    u = h(arguments[r++]),
                    f = a ? _e(u).concat(a(u)) : _e(u),
                    d = f.length,
                    p = 0;
                  d > p;

                )
                  (c = f[p++]), (o && !s.call(u, c)) || (n[c] = u[c]);
              return n;
            }
          : mr,
      yr = function (e) {
      ...
      Ar = function (e) {
        var t,
          ...
          h = 0;
        if (
          (f && (u = ot(u, c > 2 ? arguments[2] : void 0, 2)),
          null == d || (l == Array && Tr(d)))
        )
          for (n = new l((t = ce(s.length))); t > h; h++)
            (a = f ? u(s[h], h) : s[h]), Wn(n, h, a);
        else
          for (
            o = (r = d.call(s)).next, n = new l();
            !(i = o.call(r)).done;
            h++
          )
            (a = f ? br(r, u, [i.value, h], !0) : i.value), Wn(n, h, a);
        return (n.length = h), n;
      },
      Cr = 2147483647,
      Pr = /[^\0-\u007E]/,
      ...
      ro = function () {
        ...
        if (
          ...
          if (g(c))
            ...
            else for (l in c) b(c, l) && f.push({ key: l, value: c[l] + "" });
          else
            eo(
              f,
              "string" == typeof c
    ...
    Mr(
      ...
      it(ro, qr),
      je({ global: !0, forced: !hr }, { URLSearchParams: ro }),
      hr ||
        "function" != typeof Ur ||
        "function" != typeof Dr ||
        je(
    ...
    it(ga, "URL"),
      je({ global: !0, forced: !hr, sham: !o }, { URL: ga }),
      (function (e) {
        var t = (function () {
            try {
    ...
    je(
      { target: "Array", proto: !0, forced: !fs },
      {
        includes: function (e) {
    ...
    var ds = ut.map,
      ...
      ps = Zt("map");
    je(
      { target: "Array", proto: !0, forced: !hs || !ps },
      {
        map: function (e) {
    ...
    if (Oe(Cs, !Ps(" 0o1") || !Ps("0b1") || Ps("+0x1"))) {
      for (
        ...
        b(Ps, (js = Ns[Rs])) && !b(Ls, js) && Es(Ls, js, Ss(Ps, js));
      ...
      Us = function (e) {
        return function (t) {
          for (var n, i = m(t), r = _e(i), a = r.length, s = 0, l = []; a > s; )
            (n = r[s++]), (o && !_s.call(i, n)) || l.push(e ? [n, i[n]] : i[n]);
          return l;
        };
      },
    ...
    je(
      { target: "String", proto: !0, forced: !Bs("includes") },
      {
        includes: function (e) {
    ...
    var nl = {
        getConstructor: function (e, t, n, i) {
          var r = e(function (e, o) {
              pr(e, r, t),
                Ys(e, { type: t, id: Js++, frozen: void 0 }),
                null != o && Ks(o, e[i], { that: e, AS_ENTRIES: n });
            }),
            o = Gs(t),
            a = function (e, t, n) {
              var i = o(e),
              ...
              if (
                ...
                v ||
                  (((u = t(function (t, n) {
                    ...
                    var i = ms(new l(), t, u);
                    return (
                      null != n && Ks(n, i[s], { that: i, AS_ENTRIES: o }), i
                    );
                  })).prototype = c),
                  (c.constructor = u)),
                  (m || y) && (d("delete"), d("has"), o && d("get")),
                  (y || p) && d(s),
                  a && c.clear && delete c.clear;
              }
              return (
                (f[e] = u),
                je({ global: !0, forced: u != l }, f),
                it(u, e),
                a || n.setStrong(u, e, o),
                u
              );
            ...
            Mr(c, {
              ...
              get: function (e) {
                if (g(e) && !a(e)) {
                  ...
                  return (
                    i.frozen || (i.frozen = new t()),
                    f.call(this, e) ? d.call(this, e) : i.frozen.get(e)
                  );
                }
              ...
              set: function (e, i) {
                if (g(e) && !a(e)) {
                  ...
                  r.frozen || (r.frozen = new t()),
                    f.call(this, e) ? h.call(this, e, i) : r.frozen.set(e, i);
    ...
    var sl = ut.some,
      ...
      cl = Zt("some");
    je(
      { target: "Array", proto: !0, forced: !ll || !cl },
      {
        some: function (e) {
    ...
    je(
      { target: "Number", proto: !0, forced: pl },
      {
        toFixed: function (e) {
          var t,
            n,
            ...
            u = function (e, t) {
              for (var n = -1, i = t; ++n < 6; )
                (i += e * s[n]), (s[n] = i % 1e7), (i = dl(i / 1e7));
            },
            d = function (e) {
              for (var t = 6, n = 0; --t >= 0; )
                (n += s[t]), (s[t] = dl(n / e)), (n = (n % e) * 1e7);
            },
            h = function () {
              for (var e = 6, t = ""; --e >= 0; )
                if ("" !== t || 0 === e || 0 !== s[e]) {
      ...
      Hl = (function () {
        function e(t, n) {
          (function (e, t) {
            ...
            Rl(t)
              ? (this.element = t)
              : jl(t) && (this.element = document.querySelector(t)),
            Rl(this.element) &&
          ...
          : Ql && !Wl
            ...
            : i.addEventListener &&
              ...
              : (Dl =
                  tc in T("script")
                    ? function (e) {
                        De.appendChild(T("script")).onreadystatechange =
                          function () {
    ...
    Tc ||
      ...
      !Wl && !Kl && vc && yc
        ? ((uc = !0),
          (fc = yc.createTextNode("")),
          new vc(ac).observe(fc, { characterData: !0 }),
          (cc = function () {
            fc.data = uc = !uc;
          }))
        : wc && wc.resolve
          ? ((dc = wc.resolve(void 0)),
            (hc = dc.then),
            (cc = function () {
              hc.call(dc, ac);
            }))
              ...
              try {
                u
                  ? (r || (2 === e.rejection && tu(e), (e.rejection = 1)),
                    !0 === u
                      ? (a = i)
                      : (h && h.enter(), (a = u(i)), h && (h.exit(), (l = !0))),
                    a === c.promise
                      ? d(Fc("Promise-chain cycle"))
                      : (s = Xc(a))
                        ? s.call(a, f, d)
                        : f(a))
                  : d(i);
    ...
    Yc &&
      ...
      je({ global: !0, wrap: !0, forced: Yc }, { Promise: Dc }),
      it(Dc, Rc, !1),
      zl(Rc),
      (Ac = re(Rc)),
      je(
    ...
    var fu,
      ...
      Uu = Tu,
      Du =
        ((fu = document.createElement("span")),
        (du = {
    ...
    function Qu(e) {
      Iu(e) || Ou(e)
        ...
        : ju(e) && ju(e.parentNode) && e.parentNode.removeChild(e);
    }
    ...
    function Zu(e, t) {
      return ju(t) && ju(t.parentNode) && ju(e)
    ...
    function bf() {
      ...
      return new Promise(function (t) {
        return e.ready
          ? setTimeout(t, 0)
          : pf.call(e, e.elements.container, "ready", t);
      }).then(function () {});
    }
      ...
      setup: function () {
        if (this.isHTML5) {
          ...
          (e.options.speed = e.config.speed.options),
            Uu(this.config.ratio) || Ef.call(e),
    ...
    if (
      ...
      for (
        var Uf = function (e, t) {
            var n,
              i = this instanceof Uf,
              r = Yi(e),
              o = void 0 === t;
            if (!i && r && e.constructor === Uf && o) return e;
            Mf
              ? r && !o && (e = e.source)
              : e instanceof Uf && (o && (t = ui.call(e)), (e = e.source)),
              _f &&
                (n = !!t && t.indexOf("y") > -1) &&
                (t = t.replace(/y/g, ""));
          ...
          Ra(this, e),
            ...
            Ua(this, "set", function (t) {
              if (e.supported && n.enabled && Eu(t)) {
                ...
                Uu(i) && (i = {}),
                  Ku(i, t),
                  window.localStorage.setItem(n.key, JSON.stringify(i));
              }
            }),
    ...
    var id = {
      ...
      findElements: function () {
        try {
          return (
            (this.elements.controls = sf.call(
              this,
            ...
            (this.elements.progress = sf.call(
              this,
      ...
      createButton: function (e, t) {
        ...
        return (
          o.toggle
            ? (a.appendChild(
                id.createIcon.call(this, o.iconPressed, {
                  class: "icon--pressed",
                }),
              ),
              a.appendChild(
                id.createIcon.call(this, o.icon, {
                  class: "icon--not-pressed",
                }),
              ),
              a.appendChild(
                id.createLabel.call(this, o.labelPressed, {
                  class: "label--pressed",
                }),
              ),
              a.appendChild(
                id.createLabel.call(this, o.label, {
                  class: "label--not-pressed",
                }),
              ))
            : (a.appendChild(id.createIcon.call(this, o.icon)),
              a.appendChild(id.createLabel.call(this, o.label))),
          Ku(i, ef(this.config.selectors.buttons[r], i)),
          Yu(a, i),
          "play" === r
      ...
      createRange: function (e, t) {
        var n = Gu(
          "input",
          Ku(
            ef(this.config.selectors.inputs[e]),
            {
              type: "range",
              min: 0,
              max: 100,
        ...
        return (
          ...
          id.updateRangeFill.call(this, n),
          Hl.setup(n),
          n
        );
      },
      createProgress: function (e, t) {
        var n = Gu(
          "progress",
          Ku(
            ef(this.config.selectors.display[e]),
            {
              min: 0,
              max: 100,
              value: 0,
        ...
        pf.call(
          ...
          function (i) {
            if (
              ...
              var r,
                o = of(e, '[role="menuitemradio"]');
              if (!o && [32, 39].includes(i.which))
                id.showMenuPanel.call(n, t, !0);
              else
                32 !== i.which &&
                  (40 === i.which || (o && 39 === i.which)
                    ? ((r = e.nextElementSibling),
                      ju(r) || (r = e.parentNode.firstElementChild))
                    : ((r = e.previousElementSibling),
                      ju(r) || (r = e.parentNode.lastElementChild)),
                  lf.call(n, r, !0));
            }
          },
          !1,
        ),
          pf.call(this, e, "keyup", function (e) {
        ...
        (d.innerHTML = o),
          ...
          this.listeners.bind(
            ...
            function (e) {
              if (!Nu(e) || 32 === e.which) {
                switch (
                  (e.preventDefault(), e.stopPropagation(), (f.checked = !0), r)
                ) {
                  case "language":
          ...
          id.bindMenuItemShortcuts.call(this, f, r),
          i.appendChild(f);
      },
      formatTime: function () {
        var e =
      ...
      updateVolume: function () {
        this.supported.ui &&
          (ju(this.elements.inputs.volume) &&
            id.setRange.call(
              this,
              this.elements.inputs.volume,
              this.muted ? 0 : this.volume,
            ),
          ju(this.elements.buttons.mute) &&
            ...
            switch (e.type) {
              ...
              case "seeked":
                (n = (function (e, t) {
                  ...
                  "timeupdate" === e.type &&
                    id.setRange.call(this, this.elements.inputs.seek, n);
                break;
              case "playing":
              case "progress":
                !(function (e, n) {
      ...
      updateSeekTooltip: function (e) {
        ...
        if (
          ...
          ju(this.elements.inputs.seek) &&
          ju(this.elements.display.seekTooltip) &&
          0 !== this.duration
        ) {
      ...
      durationUpdate: function () {
        if (
          ...
          if (this.duration >= Math.pow(2, 32))
            return (
              tf(this.elements.display.currentTime, !0),
              void tf(this.elements.progress, !0)
            );
          ju(this.elements.inputs.seek) &&
          ...
          !e &&
            ...
            id.updateSeekTooltip.call(this);
        }
      },
      ...
      updateSetting: function (e, t, n) {
        ...
        if ((ju(o) || (o = i && i.querySelector('[role="menu"]')), ju(o))) {
          ...
          ).innerHTML = id.getLabel.call(this, e, r);
      ...
      setQualityMenu: function (e) {
        ...
        if (ju(this.elements.settings.panels.quality)) {
          ...
          Ou(e) &&
            (this.options.quality = Cf(e).filter(function (e) {
              return t.config.quality.options.includes(e);
            }));
          var r = !Uu(this.options.quality) && this.options.quality.length > 1;
          if (
            (id.toggleMenuButton.call(this, n, r),
            Ju(i),
            id.checkMenu.call(this),
            r)
          ) {
            var o = function (e) {
      ...
      setCaptionsMenu: function () {
        ...
        if (ju(this.elements.settings.panels.captions)) {
          var t = "captions",
            ...
            r = Boolean(i.length);
          if (
            (id.toggleMenuButton.call(this, t, r),
            Ju(n),
            id.checkMenu.call(this),
            r)
          ) {
            var o = i.map(function (t, i) {
              return {
                ...
                badge:
                  t.language &&
                  id.createBadge.call(e, t.language.toUpperCase()),
                list: n,
                type: "language",
              };
            });
            o.unshift({
              ...
              o.forEach(id.createMenuItem.bind(this)),
      ...
      setSpeedMenu: function () {
        ...
        if (ju(this.elements.settings.panels.speed)) {
          ...
          id.toggleMenuButton.call(this, t, i),
            Ju(n),
            id.checkMenu.call(this),
            i &&
      ...
      toggleMenu: function (e) {
        ...
        if (ju(t) && ju(n)) {
          ...
          n.setAttribute("aria-expanded", r),
            tf(t, !r),
            nf(this.elements.container, this.config.classNames.menu.open, r),
            r && Nu(e)
              ? id.focusFirstMenuItem.call(this, null, !0)
              : r || i || lf.call(this, n, Nu(e));
        }
      },
      ...
      create: function (e) {
        ...
        return (
          Cf(Ou(this.config.controls) ? this.config.controls : []).forEach(
            function (s) {
              if (
                ("restart" === s && u.appendChild(i.call(t, "restart", f)),
                "rewind" === s && u.appendChild(i.call(t, "rewind", f)),
                "play" === s && u.appendChild(i.call(t, "play", f)),
                "fast-forward" === s &&
                  u.appendChild(i.call(t, "fast-forward", f)),
                "progress" === s)
              ) {
                var l = Gu("div", {
                ...
                (t.elements.progress = d),
                  l.appendChild(t.elements.progress),
                  u.appendChild(l);
              }
              if (
                ("current-time" === s &&
                  u.appendChild(a.call(t, "currentTime", f)),
              ...
              if (
                ("captions" === s && u.appendChild(i.call(t, "captions", f)),
                ...
                b.appendChild(w),
                  ...
                  t.config.settings.forEach(function (i) {
                    var r = Gu(
                      "button",
                      Ku(ef(t.config.selectors.buttons.settings), {
                        type: "button",
                        class: ""
                    ...
                    l.appendChild(
                      Gu("span", { "aria-hidden": !0 }, $f(i, t.config)),
                    ),
                      l.appendChild(
                        Gu(
                          "span",
              ...
              if (
                ("pip" === s && ff.pip && u.appendChild(i.call(t, "pip", f)),
                "airplay" === s &&
                  ff.airplay &&
                  u.appendChild(i.call(t, "airplay", f)),
                "download" === s)
              ) {
                var k = Ku({}, f, {
                  element: "a",
          ...
          this.isHTML5 && s.call(this, Af.getQualityOptions.call(this)),
          l.call(this),
          u
        );
      },
      inject: function () {
        ...
        xu(this.config.controls) &&
          ...
          ju(this.config.controls) || Cu(this.config.controls)
            ? (n = this.config.controls)
            : ((n = id.create.call(this, {
                id: this.id,
                seektime: this.config.seekTime,
                speed: this.speed,
        ...
        if (
          ...
          ju(a) || (a = this.elements.container),
          a[ju(n) ? "insertAdjacentElement" : "insertAdjacentHTML"](
            "afterbegin",
            n,
          ),
          ju(this.elements.controls) || id.findElements.call(this),
        ...
        if ((qu.isEdge && Fu(a), this.config.tooltips.controls)) {
          ...
          Array.from(d).forEach(function (t) {
            nf(t, e.config.classNames.hidden, !1),
              nf(t, e.config.classNames.tooltip, !0);
          });
        }
      },
    };
        ...
        setup: function () {
          if (this.supported.ui)
            if (
              !this.isVideo ||
              this.isYouTube ||
              (this.isHTML5 && !ff.textTracks)
            )
              Ou(this.config.controls) &&
                this.config.controls.includes("settings") &&
                this.config.settings.includes("captions") &&
                id.setCaptionsMenu.call(this);
            else {
              if (
                (ju(this.elements.captions) ||
                  ((this.elements.captions = Gu(
                    "div",
                    ef(this.config.selectors.captions),
                  )),
                  (function (e, t) {
                    ju(e) &&
                      ju(t) &&
            ...
            t
              ...
              .forEach(function (t) {
                e.debug.log("Track added", t),
                  ...
                  pf.call(e, t, "cuechange", function () {
                    return ad.updateCues.call(e);
                  });
              }),
            ((s && this.language !== r) || !t.includes(a)) &&
              (ad.setLanguage.call(this, r), ad.toggle.call(this, i && s)),
            nf(
            ...
            if (o !== i) {
              if (
                ...
                return (
                  ...
                  void ad.set.call(this, a.indexOf(s))
                );
              }
              this.elements.buttons.captions &&
                (this.elements.buttons.captions.pressed = o),
                nf(this.elements.container, r, o),
                (this.captions.toggled = o),
                id.updateSetting.call(this, "captions"),
                vf.call(
                  this,
                  this.media,
              ...
              if (e in n) {
                if (this.captions.currentTrack !== e) {
                  ...
                  (this.captions.currentTrackNode = i),
                    ...
                    vf.call(this, this.media, "languagechange");
                }
                ad.toggle.call(this, !0, t),
                  this.isHTML5 && this.isVideo && ad.updateCues.call(this);
        ...
        getLabel: function (e) {
          ...
          return (
            !Ru(t) &&
              ...
              (t = ad.getCurrentTrack.call(this)),
            Ru(t)
              ? Uu(t.label)
                ? Uu(t.language)
                  ? $f("enabled", this.config)
                  : e.language.toUpperCase()
                : t.label
              : $f("disabled", this.config)
          );
        },
              ...
              if (Su(e) || Array.isArray(e)) {
                ...
                if (i !== this.elements.captions.innerHTML) {
                  ...
                  (r.innerHTML = i),
                    ...
                    vf.call(this, this.media, "cuechange");
                }
          ...
          Ra(this, e),
            ...
            Ua(this, "toggleFallback", function () {
              ...
              if (
                ...
                nf(n.target, n.player.config.classNames.fullscreen.fallback, e),
                qu.isIos)
              ) {
            ...
            Ua(this, "trapFocus", function (e) {
              if (!qu.isIos && n.active && "Tab" === e.key && 9 === e.keyCode) {
                var t = document.activeElement,
                  ...
                  o = i[i.length - 1];
                t !== o || e.shiftKey
                  ? t === r && e.shiftKey && (o.focus(), e.preventDefault())
            ...
            Ua(this, "enter", function () {
              n.enabled &&
                (qu.isIos && n.player.config.fullscreen.iosNative
                  ? n.player.isVimeo
            ...
            Ua(this, "exit", function () {
              if (n.enabled)
                if (qu.isIos && n.player.config.fullscreen.iosNative)
                  n.target.webkitExitFullscreen(), wf(n.player.play());
        ...
        build: function () {
          ...
          if ((this.listeners.media(), !this.supported.ui))
            return (
              ...
              void yd.toggleNativeControls.call(this, !0)
            );
          ju(this.elements.controls) ||
            (id.inject.call(this), this.listeners.controls()),
            yd.toggleNativeControls.call(this),
            this.isHTML5 && ad.setup.call(this),
            (this.volume = null),
            (this.muted = null),
            (this.loop = null),
            (this.quality = null),
            (this.speed = null),
            id.updateVolume.call(this),
            id.timeUpdate.call(this),
            yd.checkPlaying.call(this),
            nf(
              this.elements.container,
              this.config.classNames.pip.supported,
              ff.pip && this.isHTML5 && this.isVideo,
            ),
            nf(
              this.elements.container,
              this.config.classNames.airplay.supported,
              ff.airplay && this.isHTML5,
            ),
            nf(this.elements.container, this.config.classNames.isIos, qu.isIos),
            nf(
              this.elements.container,
            ...
            yd.setTitle.call(this),
            this.poster &&
              yd.setPoster.call(this, this.poster, !1).catch(function () {}),
            this.config.duration && id.durationUpdate.call(this);
        },
        setTitle: function () {
          ...
          nf(
            ...
            Array.from(this.elements.buttons.play || []).forEach(function (e) {
              Object.assign(e, { pressed: t.playing }),
                e.setAttribute(
                  "aria-label",
                  $f(t.playing ? "pause" : "play", t.config),
                );
            }),
          ...
          Ra(this, e),
            ...
            Ua(this, "global", function () {
              ...
              t.config.keyboard.global &&
                hf.call(t, window, "keydown keyup", n.handleKey, e, !1),
                hf.call(t, document.body, "click", n.toggleMenu, e),
                gf.call(t, document.body, "touchstart", n.firstTouch),
                hf.call(
                  t,
                  document.body,
            ...
            Ua(this, "container", function () {
              ...
              !t.keyboard.global &&
                t.keyboard.focused &&
                pf.call(e, i.container, "keydown keyup", n.handleKey, !1),
                pf.call(
                  e,
                  i.container,
                ...
                function (t) {
                  ...
                  if (r === i.container && (e.isEmbed || !Uu(e.config.ratio))) {
                    ...
                    !(function (t, n, i) {
                      ...
                      s ||
                        (l
                          ? pf.call(e, window, "resize", a)
                          : mf.call(e, window, "resize", a));
                  }
                },
              );
            }),
            Ua(this, "media", function () {
              var e = n.player,
                t = e.elements;
              if (
                (pf.call(e, e.media, "timeupdate seeking seeked", function (t) {
                ...
                pf.call(e, t.container, "click", function (r) {
                  ([t.container, i].includes(r.target) ||
                    i.contains(r.target)) &&
                    ((e.touch && e.config.hideControls) ||
                      (e.ended
                        ? (n.proxy(r, e.restart, "restart"),
                          n.proxy(
                            r,
                            function () {
                              wf(e.play());
              ...
              e.supported.ui &&
                ...
                pf.call(e, e.media, "volumechange", function () {
                  e.storage.set({ volume: e.volume, muted: e.muted });
                }),
                pf.call(e, e.media, "ratechange", function () {
                  id.updateSetting.call(e, "speed"),
              ...
              pf.call(e, e.media, r, function (n) {
                ...
                "error" === n.type && (r = e.media.error),
                  vf.call(e, t.container, n.type, !0, r);
              });
            }),
            ...
            Ua(this, "controls", function () {
                    ...
                    [13, 32].includes(n) &&
                      (13 !== n
                        ? (t.preventDefault(),
                          t.stopPropagation(),
                          id.toggleMenu.call(e, t))
                        : id.focusFirstMenuItem.call(e, null, !0));
                  },
                  null,
                  !1,
                ),
                ...
                n.bind(
                  ...
                  function (t) {
                    ...
                    if (!Nu(t) || 39 === i || 37 === i) {
                      ...
                      o && a
                        ? (n.removeAttribute(r), wf(e.play()))
                        : !a && e.playing && (n.setAttribute(r, ""), e.pause());
                    }
                  },
                ),
                qu.isIos)
              ...
              n.bind(
                ...
                qu.isWebkit &&
                  Array.from(af.call(e, 'input[type="range"]')).forEach(
                    function (t) {
                ...
                n.bind(t.controls, "focusin", function () {
                  var i = e.config,
                    r = e.timers;
                  nf(t.controls, i.classNames.noTransition, !0),
                    yd.toggleControls.call(e, !0),
                    setTimeout(function () {
                ...
                if (
                  ...
                  if (r) {
                    ...
                    if (ju(a)) {
                      ...
                      if (32 === e.which && of(a, 'button, [role^="menuitem"]'))
                        return;
                    }
                    switch (
                      ([
    ...
    je(
      { target: "Array", proto: !0, forced: !wd || !kd },
      {
        splice: function (e, t) {
          var n,
            i,
    ...
    function xd(e) {
      e && !this.embed.hasPlayed && (this.embed.hasPlayed = !0),
        this.media.paused === e &&
          ((this.media.paused = !e),
          vf.call(this, this.media, e ? "play" : "pause"));
    }
    var Od = {
      setup: function () {
        var e = this;
        nf(e.elements.wrapper, e.config.classNames.embed, !0),
          (e.options.speed = e.config.speed.options),
          Ef.call(e),
          Eu(window.Vimeo)
            ? Od.ready.call(e)
            : Pd(e.config.urls.vimeo.sdk)
                .then(function () {
                  Od.ready.call(e);
                })
                .catch(function (t) {
      ...
      ready: function () {
        ...
        n.customControls ||
          Gf(Hf(t.config.urls.vimeo.api, f)).then(function (e) {
            !Uu(e) &&
              e.thumbnail_url &&
              yd.setPoster.call(t, e.thumbnail_url).catch(function () {});
          }),
        ...
        Object.defineProperty(t.media, "loop", {
          ...
          t.embed.on("loaded", function () {
            ...
            ju(t.embed.element) && t.supported.ui) &&
          ...
          t.embed.on("timeupdate", function (e) {
            (t.media.seeking = !1),
              (h = e.seconds),
              vf.call(t, t.media, "timeupdate");
          }),
          t.embed.on("progress", function (e) {
            (t.media.buffered = e.percent),
              vf.call(t, t.media, "progress"),
              1 === parseInt(e.percent, 10) &&
                vf.call(t, t.media, "canplaythrough"),
              t.embed.getDuration().then(function (e) {
                e !== t.media.duration &&
                  ((t.media.duration = e),
                  vf.call(t, t.media, "durationchange"));
              });
          }),
    ...
    var Ld = {
        setup: function () {
          var e = this;
          if (
            (nf(this.elements.wrapper, this.config.classNames.embed, !0),
        ...
        getTitle: function (e) {
          var t = this;
          Gf(Hf(this.config.urls.youtube.api, e))
            .then(function (e) {
              if (Eu(e)) {
                var n = e.title,
                  i = e.height,
              ...
              events: {
                ...
                onPlaybackRateChange: function (t) {
                  ...
                  (e.media.playbackRate = n.getPlaybackRate()),
                    vf.call(e, e.media, "ratechange");
                },
                onReady: function (n) {
                  if (!xu(e.media.play)) {
                    var i = n.target;
                    Ld.getTitle.call(e, a),
                    ...
                    Object.defineProperty(e.media, "volume", {
                      ...
                      set: function (t) {
                        (r = t),
                          i.setVolume(100 * r),
                          vf.call(e, e.media, "volumechange");
                      },
                    });
                    ...
                    (e.options.speed = s.filter(function (t) {
                      ...
                      vf.call(e, e.media, "durationchange"),
                      clearInterval(e.timers.buffering),
                      (e.timers.buffering = setInterval(function () {
                        (e.media.buffered = i.getVideoLoadedFraction()),
                          (null === e.media.lastBuffered ||
                            e.media.lastBuffered < e.media.buffered) &&
                            vf.call(e, e.media, "progress"),
                          (e.media.lastBuffered = e.media.buffered),
                          1 === e.media.buffered &&
                            (clearInterval(e.timers.buffering),
                            vf.call(e, e.media, "canplaythrough"));
                      }, 200)),
                      t.customControls &&
                        setTimeout(function () {
                ...
                onStateChange: function (n) {
                  ...
                  switch (
                    ...
                    e.media.seeking &&
                      [1, 2].includes(n.data) &&
                      ((e.media.seeking = !1), vf.call(e, e.media, "seeked")),
                    n.data)
                  ) {
                    case -1:
                      vf.call(e, e.media, "timeupdate"),
          ...
          this.media
            ? (nf(
              ...
              this.isHTML5
                ...
                : this.isYouTube
                  ? Ld.setup.call(this)
                  : this.isVimeo && Od.setup.call(this))
      ...
      Rd = (function () {
        function e(t) {
          var n = this;
          Ra(this, e),
            Ua(this, "load", function () {
              n.enabled &&
                (Eu(window.google) && Eu(window.google.ima)
                  ? n.ready()
                  : Pd(n.player.config.urls.googleIMA.sdk)
                      .then(function () {
                        n.ready();
                      })
                      .catch(function () {
            ...
            Ua(this, "pollCountdown", function () {
              ...
              var t = function () {
                var e = nd(Math.max(n.manager.getRemainingTime(), 0)),
                  t = ""
                    .concat($f("advertisement", n.player.config), " - ")
                    .concat(e);
            ...
            Ua(this, "listeners", function () {
              ...
              n.player.on("canplay", function () {
                ...
                n.player.on("seeked", function () {
                  ...
                  Uu(n.cuePoints) ||
                    n.cuePoints.forEach(function (i, r) {
                      e < i &&
                        i < t &&
                        (n.manager.discardAdBreak(), n.cuePoints.splice(r, 1));
                    });
                }),
            ...
            Ua(this, "on", function (e, t) {
              return (
                Ou(n.events[e]) || (n.events[e] = []), n.events[e].push(t), n
              );
            }),
    ...
    _d in [] &&
      ...
      je(
        { target: "Array", proto: !0, forced: Ud || !Dd },
        {
        ...
        Hd || !Bd || !Vd
          ? function (e) {
              ...
              var t = m(this),
                ...
                i = n - 1;
              for (
                arguments.length > 1 && (i = Fd(i, se(arguments[1]))),
                  i < 0 && (i = n + i);
                i >= 0;
                i--
              )
          ...
          : qd;
    je(
      { target: "Array", proto: !0, forced: zd !== [].lastIndexOf },
      { lastIndexOf: zd },
    );
    var Wd = function (e, t) {
        var n = {};
          ...
          Ra(this, e),
            ...
            Ua(this, "startMove", function (e) {
              if (
                ...
                if ("touchmove" === e.type)
                  ...
                  (n.seekTime = n.player.media.duration * (i / 100)),
                    n.seekTime < 0 && (n.seekTime = 0),
                    n.seekTime > n.player.media.duration - 1 &&
                      (n.seekTime = n.player.media.duration - 1),
                    (n.mousePosX = e.pageX),
                    (n.elements.thumb.time.innerText = nd(n.seekTime));
                }
            ...
            Ua(this, "showImageAtCurrentTime", function () {
              ...
              n.mouseDown || n.toggleThumbContainer(t),
                t &&
                  (n.thumbnails.forEach(function (t, r) {
                    n.loadedImages.includes(t.frames[e].text) && (i = r);
                  }),
                  e !== n.showingThumb &&
                    ((n.showingThumb = e), n.loadImage(i)));
            }),
            ...
            Ua(this, "showImage", function (e, t, i, r, o) {
              ...
              n.player.debug.log(
                ...
                n
                  .preloadNearby(r, !0)
                  .then(n.preloadNearby(r, !1))
                  .then(n.getHigherQuality(i, e, t, o));
            }),
            Ua(this, "removeOldImages", function (e) {
              Array.from(n.currentImageContainer.children).forEach(
                function (t) {
            ...
            Ua(this, "getHigherQuality", function (e, t, i, r) {
              if (e < n.thumbnails.length - 1) {
                ...
                n.usingSprites && (o = i.h),
                  o < n.thumbContainerHeight &&
                    setTimeout(function () {
                      n.showingThumbFilename === r &&
                        (n.player.debug.log(
            ...
            Ua(this, "toggleThumbContainer", function () {
              var e =
                ...
                i =
                  n.player.config.classNames.previewThumbnails
                    .thumbContainerShown;
              n.elements.thumb.container.classList.toggle(i, e),
                !e &&
                  t &&
              ...
              this.destroy.call(
                ...
                function () {
                  ...
                  Object.assign(t, {
                    ...
                    yd.addStyleHook.call(t),
                    t.isHTML5 && $d.insertElements.call(t, "source", n),
                    (t.config.title = e.title),
                    Nd.setup.call(t),
                    t.isHTML5 &&
                      Object.keys(e).includes("tracks") &&
                      $d.insertElements.call(t, "track", e.tracks),
      ...
      Gd = (function () {
        function e(t, n) {
          ...
          if (
            ...
            Ua(this, "toggleControls", function (e) {
              if (i.supported.ui && !i.isAudio) {
                var t = rf(
                    ...
                    i.config.classNames.hideControls,
                  ),
                  n = void 0 === e ? void 0 : !e,
                  r = nf(
                    i.elements.container,
                ...
                if (
                  (r &&
                    Ou(i.config.controls) &&
                    i.config.controls.includes("settings") &&
                    !Uu(i.config.settings) &&
                    id.toggleMenu.call(i, !1),
                  r !== t)
                ) {
              ...
              if (i.ready) {
                var n = function () {
                  (document.body.style.overflow = ""),
                    (i.embed = null),
                    t
                      ? (Object.keys(i.elements).length &&
                          (Qu(i.elements.buttons.play),
                          Qu(i.elements.captions),
                          Qu(i.elements.controls),
                          Qu(i.elements.wrapper),
                          (i.elements.buttons.play = null),
                          (i.elements.captions = null),
                          (i.elements.controls = null),
                          (i.elements.wrapper = null)),
                        xu(e) && e())
                      : (yf.call(i),
                        Af.cancelRequests.call(i),
                        Zu(i.elements.original, i.elements.container),
                        vf.call(i, i.elements.original, "destroyed", !0),
                        xu(e) && e.call(i.elements.original),
                        (i.ready = !1),
                        setTimeout(function () {
                ...
                i.stop(),
                  clearTimeout(i.timers.loading),
                  clearTimeout(i.timers.controls),
                  clearTimeout(i.timers.resized),
                  i.isHTML5
                    ? (yd.toggleNativeControls.call(i, !0), n())
                    : i.isYouTube
                      ? (clearInterval(i.timers.buffering),
                        clearInterval(i.timers.playing),
                        null !== i.embed &&
                          xu(i.embed.destroy) &&
                          i.embed.destroy(),
                        n())
                      : i.isVimeo &&
                        (null !== i.embed && i.embed.unload().then(n),
                        setTimeout(n, 200));
              }
            }),
            ...
            (this.debug = new pd(this.config.debug)),
            this.debug.log("Config", this.config),
            this.debug.log("Support", ff),
            !Su(this.media) && ju(this.media))
          )
              ...
              if (ff.check().api) {
                ...
                switch (o) {
                  case "div":
                    ...
                    if (
                      Uu(this.provider) ||
                      !Object.values(ud).includes(this.provider)
                    )
                ...
                (this.supported = ff.check(
                  ...
                  this.supported.api
                    ? ((this.eventListeners = []),
                      ...
                      this.config.ads.enabled && (this.ads = new Rd(this)),
                      this.isHTML5 &&
                      ...
                      this.config.previewThumbnails.enabled &&
                        (this.previewThumbnails = new Kd(this)))
          ...
          _a(
            ...
            [
              ...
              },
              {
                ...
                set: function (e) {
                  this.isVideo
                    ? yd.setPoster.call(this, e, !1).catch(function () {})
              ...
              },
              {
                ...
                set: function (e) {
                  this.isVideo
                    ? Cu(e) && kf(e)
                      ? ((this.config.ratio = e), Ef.call(this))
                      : this.debug.error(
                ...
                set: function (e) {
                  if (ff.pip) {
                    ...
                    xu(this.media.webkitSetPresentationMode) &&
                      this.media.webkitSetPresentationMode(t ? ld : cd),
                ...
                get: function () {
                  return ff.pip
                    ? Uu(this.media.webkitPresentationMode)
                      ...
                      : this.media.webkitPresentationMode === ld
                    : null;
                },
              },
            ],
