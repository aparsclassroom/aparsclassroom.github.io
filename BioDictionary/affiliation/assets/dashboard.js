...
const tranApi =
  "https://script.google.com/macros/s/AKfycbwZymEdn7an8IRiwofv9DVXPkhYAvvIaSwdsVK7jf6NByGIGAgvv16Yy-7VRH5haVo1/exec";
  ...
  firebase.auth().onAuthStateChanged(function (user) {
    if (user) {
      ...
      if (free === true) {
        ...
        fetch(api + "?q=analytics&uid=" + user.uid)
          .then((res) => {
            return res.json();
          })
          .then((loadedData) => {
            if (loadedData.code === 200) {
              ...
              document.getElementById("inWallet").innerText =
                data.Remaning_in_Wallet;
              document.getElementById("totalEarning").innerText =
                data.Total_Income;
              document.getElementById("ttsell").innerText = data.Total_Sell;
              document.getElementById("totalVerify").innerText =
                data.Total_Income + " ৳";
                  ...
                  buttons: [
                    {
                      ...
                      text: "Excel",
                      filename:
                        "Transactions of " + tdate + "-" + month + "-" + year,
              ...
              alert(
                "ফ্রী লাইসেন্সড একাউন্টদের এফিলিয়েশনে যুক্ত করার কাজ চলছে সঙ্গেই থাকুন !",
              );
