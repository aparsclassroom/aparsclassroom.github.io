...
/*
 * Developed by : maheyanmridul.wordpress.com
 *
 ...
 *
 * History:
 *  v0.5 - Country wasn't supported
 * 
*/

(function () {
	// http://maheyanmridul.wordpress.com/
	"use strict";
	...
	$.fn.mapsed = function (options) {
		// consts
		// - Centre of the BD (Dhaka)
		var DEFAULT_CENTER = new google.maps.LatLng(23.777176, 90.399452);
		var DEFAULT_ZOOM = 10;
		...
		var settings = $.extend({
			...
			searchOptions: {
				...
				placeholder: "e.g. Schools in Dhaka",
				...
				geoSearch: "Apars Classroom near {POSITION}"
			},
