        ...
        return (
          r.forEach(function (t) {
            "radio" !== t.type && "checkbox" !== t.type
              ? e.push({ name: t.name, value: t.value, type: t.type })
              : t.checked &&
                e.push({ name: t.name, value: t.value, type: t.type });
          }),
          e
        ...
        if (null !== localStorage.getItem(o)) {
          JSON.parse(localStorage.getItem(o)).forEach(function (e) {
            if ("radio" !== e.type && "checkbox" !== e.type) {
              ...
              n.querySelectorAll("[name=" + e.name + "]").forEach(function (t) {
                t.name === e.name && t.value === e.value && (t.checked = !0);
              });
            }
          });
        }
