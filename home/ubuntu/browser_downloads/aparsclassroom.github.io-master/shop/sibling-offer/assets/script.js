$(function() {
    ...
    $("#sibliingInfo #minus5").on('click', function() {
        var initDynamicId = $(this).closest('#sibliingInfo').parent().find("[id^='data']").length;
        if (initDynamicId === 2) {
...
const scriptURL = 'https://script.google.com/macros/s/AKfycbxFFOcZOolDDj9ew_xKf_5tDTA7h55W0sxIoOW_GGf2ikL_Z-ekRvy5oQbI1ueVpBg/exec'
