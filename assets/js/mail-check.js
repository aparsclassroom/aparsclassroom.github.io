var Mailcheck = {
  ...
  topLevelThreshold: 3,
  defaultDomains:
    "yahoo.com google.com hotmail.com gmail.com me.com aol.com mac.com live.com comcast.net googlemail.com msn.com hotmail.co.uk yahoo.co.uk facebook.com verizon.net sbcglobal.net att.net gmx.com mail.com outlook.com icloud.com".split(
      " ",
    ),
  ...
  suggest: function (a, b, c, d) {
    ...
    if ((b = this.findClosestDomain(a.domain, b, d, this.domainThreshold))) {
      if (b != a.domain)
        return { address: a.address, domain: b, full: a.address + "@" + b };
    } else if (
      ((c = this.findClosestDomain(
        a.topLevelDomain,
        c,
        d,
        this.topLevelThreshold,
      )),
      a.domain && c && c != a.topLevelDomain)
    )
      return (
        (d = a.domain),
        (b = d.substring(0, d.lastIndexOf(a.topLevelDomain)) + c),
        { address: a.address, domain: b, full: a.address + "@" + b }
      );
    return !1;
  },
