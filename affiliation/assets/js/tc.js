...
function initApp() {
  firebase.auth().onAuthStateChanged(function (user) {
    if (user) {
      const script =
        "https://script.google.com/macros/s/AKfycbynylOid2GFjXCvErwpnpg-IcvgeT5Rz3gcoFdRAZVO8hv8PH8luqCAl7nMszSEVvit/exec?uid=";
      fetch(script + user.uid)
        ...
        .then((dashboard) => {
          ...
          document.getElementById("contoller").innerText =
            dashboard.Controler_Name;
          document.getElementById("contollerInfo").innerText =
            dashboard.Controler_Info;
          document.getElementById("info").href =
            "tel:" + dashboard.Controler_Info;
...
const scriptURL =
  "https://script.google.com/macros/s/AKfycbzt6RkjmEmuJhLf4_we4ytGJ2T6qQJrLp2-KtWiJvgQK5er-JYeAsggaOnQkQSZYwrBSQ/exec";
