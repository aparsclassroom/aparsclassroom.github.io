...
var sjs = SimpleJekyllSearch({
  ...
  searchResultTemplate:
    '<p style="margin-left: 20px;margin-right: 20px;color: black;"><a style="font-size:20px;" href="{url}"><b>{title}</b></a><br>{description}</p>',
  noResultsText:
    '<h3 style="color:red;text-align:center;">No results found</h3>',
  limit: 3,
  fuzzy: false,
});
