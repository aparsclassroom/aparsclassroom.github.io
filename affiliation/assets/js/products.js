...
function initApp() {
  firebase.auth().onAuthStateChanged(function (user) {
    if (user) {
      ...
      fetch(
        "https://script.google.com/macros/s/AKfycbwjUUwv6TyFDqVMOmIMPvCGwc0SqypisGuqzF3xqJ59TMVTS1_gC9a-8OIFoskXdXWe/exec",
      )
        .then((res) => {
          return res.json();
        })
