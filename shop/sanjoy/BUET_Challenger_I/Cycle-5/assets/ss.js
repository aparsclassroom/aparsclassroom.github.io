...
document.getElementById("con1").innerHTML =
  `<i title="feature" class="fa-solid fa-circle-check"></i>&nbsp; 30+ Live Classes`;
document.getElementById("con3").innerHTML =
  `<i title="feature" class="fa-solid fa-circle-check"></i>&nbsp; সপ্তাহে ৪ দিন ক্লাস`;
document.getElementById("con4").innerHTML =
  `<i title="feature" class="fa-solid fa-circle-check"></i>&nbsp; প্রতি সপ্তাহে এক্সাম`;
document.getElementById("con5").innerHTML =
  `<i title="feature" class="fa-solid fa-circle-check"></i>&nbsp; ChemShifu Special Question Bank Solve Class `;
