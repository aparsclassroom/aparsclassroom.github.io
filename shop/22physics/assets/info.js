                ...
                if (result.code === 200) {
                    ...
                    if (sum > 0.5) {
                        ...
                        swal({
                            ...
                            document.getElementById('meta').innerHTML = "তোমার ৩০০০ টাকা বকেয়া রয়েছে। নিচের বাটনগুলো থেকে তুমি তোমার ১ম পেমেন্ট সংক্রান্ত তথ্য পেয়ে যাবে। ২য় বাটনে ক্লিক করে ২য় পেমেন্টের টাকা পরিশোধ করতে পারবে।"
