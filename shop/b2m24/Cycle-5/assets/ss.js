const product = "b2m24";
const productName = "Beginner 2 Master Physics Batch for HSC 24";
const productCode = "223";
const fix = 1500;
const pls = 800;
const init = 0;
...
document.getElementById("con1").innerHTML =
  `<i class="fab fa-youtube"></i>&nbsp; সপ্তাহে দুুদিন ক্লাস`;

document.getElementById("con3").innerHTML =
  `<i class="fas fa-clinic-medical"></i>&nbsp; পদার্থবিজ্ঞান ২য় পত্র অধ‍্যায় ৭,৮,৯,১০`;
document.getElementById("con4").innerHTML =
  `<i class="fas fa-question-circle"></i>&nbsp;x Exams `;
document.getElementById("con5").innerHTML =
  `<i class="fas fa-calendar-check"></i>&nbsp;x Guideline Sessions `;
