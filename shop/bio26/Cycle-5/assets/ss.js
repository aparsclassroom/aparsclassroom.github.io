const product = "bio26";
const productName = "ACS Biology HSC 2026";
const productCode = "330";
const fix = 1500;
const pls = 1000;
const init = 0;
...
fetch(`https://${shopName2}/enrollment/${Cycle}?productCode=${productCode}`)
    ...
    document.getElementById('con1').innerHTML = `<i class="fab fa-youtube"></i>&nbsp;রবিবার, মঙ্গলবার ও বৃহস্পতিবার ক্লাস`;
    document.getElementById('con3').innerHTML = `<i class="fas fa-clinic-medical"></i>&nbsp;প্রথম পত্র- অধ্যায় (৩,৫,৬,১০,১২)`;
    document.getElementById('con4').innerHTML = `<i class="fas fa-question-circle"></i>&nbsp;শনিবার এক্সাম `;
