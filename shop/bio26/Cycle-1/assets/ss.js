...
document.getElementById("con1").innerHTML =
  `<i class="fab fa-youtube"></i>&nbsp; 30+ Live Classes`;
document.getElementById("con3").innerHTML =
  `<i class="fas fa-clinic-medical"></i>&nbsp;প্রথম পত্র - অধ্যায় (১,২,৪)`;
document.getElementById("con4").innerHTML =
  `<i class="fas fa-question-circle"></i>&nbsp;5 Exams `;
document.getElementById("con5").innerHTML =
  `<i class="fas fa-calendar-check"></i>&nbsp;1 Guideline Session `;
