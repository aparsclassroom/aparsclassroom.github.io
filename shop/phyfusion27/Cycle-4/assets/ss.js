const product = "phyfusion27";
const productName = "ACS HSC 27 Physics Fusion Academic Cycle";
const productCode = "517";
const fix = 1500;
const pls = 1000;
const init = 0;
...
fetch(`https://${shopName2}/enrollment/${Cycle}?productCode=${productCode}`)
    ...
    document.getElementById('con3').innerHTML = `<i class="fas fa-clinic-medical"></i>&nbsp;প্রথম পত্র- অধ্যায় (১০)<br>দ্বিতীয় পত্র- অধ্যায় (৯,১১)`;
