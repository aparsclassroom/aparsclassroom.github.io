const scriptURL =
  "https://script.google.com/macros/s/AKfycbxm4Zw9EP5AFK77yZFSYScANQ25Pbs5WTNH6pSWtf-UkCFWhmHL2l-0v3xvwViS1Qk/exec";
...
firebase.auth().onAuthStateChanged(function (e) {
  if (e) {
    ...
    document.getElementById("moda").innerHTML =
      'প্রিবুক করতে ক্লিক করো <i class="fas fa-arrow-right"></i>';
