...
const blockedCyclePurchaseChecks = [
    { cycle: "Cycle-1", products: ["672", "678"] },
    { cycle: "Cycle-2", products: ["673", "679"] },
    { cycle: "Cycle-3", products: ["674", "680"] },
    { cycle: "Cycle-4", products: ["675", "681"] },
    { cycle: "Cycle-5", products: ["676", "682"] },
    { cycle: "Cycle-6", products: ["677", "683"] }
];
...
firebase.auth().onAuthStateChanged(function(e) {
    if (e) {
        ...
        const purchaseChecks = [
            checkPurchase([productCode, productCode2, "684", "685", "686", "687"], e.uid),
