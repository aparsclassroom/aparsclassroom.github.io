...
const productSuffix = typeof productDisplaySuffix !== 'undefined' ? productDisplaySuffix : Cycle;
document.title = productSuffix ? productName + "(" + productSuffix + ") | ASG Shop" : productName + " | ASG Shop";
...
const bookReviewUrl = 'https://youtu.be/iQ691aLgJN4?si=MQnDQVKwEBT-NNrc';
...
document.getElementById('addBooks').addEventListener('change', function () {
    ...
    if (isShipping) {
        ...
        Swal.fire({
            ...
            `,
            imageUrl: '/assets/postimg/wjh5kn8r/compressed-image.jpg',
...
firebase.auth().onAuthStateChanged(function (e) {
    if (e) {
        ...
        const courseProducts = getConfiguredProductCodes([
        ...
        Promise.allSettled([
            ...
            checkPurchase(courseProducts, e.uid)
        ]).then((results) => {
