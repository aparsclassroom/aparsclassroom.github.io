const product = "Biology Full Academic To Medical (Full)";
const productCode = "123";
const fix = 8000;
const pls = 4900;
const product2 = "Biology Full Academic To Medical (Half)";
const productCode2 = "125";
const fix2 = 4000;
const pls2 = 3000;
...
fetch(`https://script.google.com/macros/s/AKfycbyWIcr4RhTkcP0ie_T43M4aDlk1R4-EwntmPc8b2MWNyADIJMnkvMsgG7O8TvdsZ3GO/exec?productCode=${productCode}`)
    .then((res) => {
        return res.json()
    })
    .then((data) => {
        ...
        document.getElementById('con6').innerHTML = `<i class="fas fa-user-graduate"></i>&nbsp;${types[4].TotalClasses} ${types[4].ContType} `;
