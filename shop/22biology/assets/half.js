...
document.title = product2 + " | ASG Shop";
document.getElementById('prod').innerText = product2;
...
firebase.auth().onAuthStateChanged(function(e) {
    if (e) {
        ...
        if (res != "" && res != "aff-AAA" && res != "aff-AAA-ADB" && res != "aff-Campaign") {
            swal({
                ...
                .then((report) => {
                    if (report) {
                        let ne = "aff-AAA";
                        localStorage.setItem(product2, ne);
                        ...
                        localStorage.setItem(product2, res);
                    }
                });
        } else {
            let ne = "aff-AAA";
        ...
        fetch(`https://${shopName}.herokuapp.com/${product2Code2}/purchase`, requestOptions)
            .then(response => {
                return response.json()
            })
            .then(result => {
                    ...
                    if (sum > 0.5) {
                        ...
                        swal({
                            ...
                            form.addEventListener('submit', em => {
                                ...
                                fetch(`https://${shopName}.herokuapp.com/${product2Code2}/init`, requestOptions)
                                    .then(response => {
                                        return response.json()
                                    })
                                    .then(result => {
