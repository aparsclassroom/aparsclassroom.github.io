        ...
        fetch(`https://${shopName}.herokuapp.com/${productCode}/purchase`, requestOptions)
            ...
            .then(result => {
                if (result.code === 200) {
                    ...
                    document.getElementById('meta').innerHTML = "তোমার পেমেন্ট সিস্টেম সিলেক্ট করো। তুমি চাইলে এককালীন ৪৯০০ টাকা পরিশোধ করে বায়োলজি সম্পূর্ণ বইয়ের কোর্সটি কম্পিট করতে পারো।<br> অথবা ৩০০০ টাকা দিয়ে ভর্তি হতে পারো। তবে কোর্স শুরুর ২ মাসের মধ্যে তোমাকে আরও ৩০০০ টাকা পরিশোধ করতে হবে।";
