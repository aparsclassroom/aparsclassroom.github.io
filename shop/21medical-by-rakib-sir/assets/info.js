                ...
                if (result.code === 200) {
                    ...
                    if (sum > 0.5) {
                        ...
                        swal({
                            ...
                            document.getElementById('meta').innerHTML = "<strong>তোমার ৫০০০ টাকা বকেয়া রয়েছে।</strong><br>নিচের ১ম বাটনে ক্লিক করে তুমি তোমার ১ম পেমেন্ট সংক্রান্ত তথ্য পেয়ে যাবে। <br>২য় বাটনে ক্লিক করে ২য় পেমেন্টের টাকা পরিশোধ করতে পারবে।"
                    ...
                    document.getElementById('meta').innerHTML = "তোমার পেমেন্ট সিস্টেম সিলেক্ট করো। তুমি চাইলে এককালীন ৪৯০০ টাকা দিতে পারো।<br> আবার ৫০০০ টাকা দিয়ে ভর্তি হতে পারো। তবে ২ মাসের মধ্যে তোমাকে আরও ৫০০০ টাকা দিতে হবে।";
