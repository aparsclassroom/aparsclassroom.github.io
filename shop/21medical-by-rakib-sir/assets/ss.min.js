const product = "Medical Gateway (Full)";
const productCode = "127";
const fix = 15000;
const pls = 8000;
const product2 = "Medical Gateway (Half)";
const productCode2 = "128";
const fix2 = 7500;
const pls2 = 4000;
...
fetch(`https://script.google.com/macros/s/AKfycbzJ_YL1u6FX7FeexF6iVVOCuRCpWZyvUHwCDYoQNTkJz5h7y85mzoOTkFBQrUP00i5y/exec?productCode=${productCode}`)
    .then((res) => {
        return res.json()
    })
    .then((data) => {
