...
const product = "chem28";
const product2 = "chem28wbooks";
const productName = "ACS Chemistry by ChemShifu";
const productName2 = "ACS Chemistry by ChemShifu with books";
let productCode = "654";
let productCode2 = "657";
const fix = 1500;
const pls = 1000;
const pls2 = 1350;
const init = 0;
