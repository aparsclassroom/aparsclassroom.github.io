...
Promise.all([
    ...
    getB2a28EnrollmentCount("641", Cycle),
    getB2a28EnrollmentCount("646", Cycle),
    ...
    getB2a28AfsEnrollmentCount("641"),
    getB2a28AfsEnrollmentCount(productCode),
