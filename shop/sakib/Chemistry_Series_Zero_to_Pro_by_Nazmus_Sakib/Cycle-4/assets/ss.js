...
fetch(`https://${shopName2}/enrollment/${Cycle}?productCode=${productCode}`)
    ...
    document.getElementById('con1').innerHTML = `<i class="fab fa-youtube"></i>&nbsp; 36 Live class`;
    document.getElementById('con3').innerHTML = `<i class="fas fa-clinic-medical"></i>&nbsp;04 QnA `;
