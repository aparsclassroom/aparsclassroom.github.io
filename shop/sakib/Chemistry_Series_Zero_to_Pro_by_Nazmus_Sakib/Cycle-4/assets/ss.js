...
document.getElementById("con1").innerHTML =
  `<i class="fab fa-youtube"></i>&nbsp; 36 Live class`;
document.getElementById("con3").innerHTML =
  `<i class="fas fa-clinic-medical"></i>&nbsp;04 QnA `;
document.getElementById("con4").innerHTML =
  `<i class="fas fa-question-circle"></i>&nbsp;10 Exams`;
document.getElementById("con5").innerHTML =
  `<i class="fas fa-calendar-check"></i>&nbsp;Class starts Nov 20th`;
...
document.getElementById("con9").innerHTML =
  `<i class="fab fa-facebook-square"></i></i>&nbsp; ২০ নভেম্বরের পরে সাইকেল ফি ১০০০৳ হবে।`;
