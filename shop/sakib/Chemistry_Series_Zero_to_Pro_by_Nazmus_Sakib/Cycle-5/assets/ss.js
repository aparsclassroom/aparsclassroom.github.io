...
document.getElementById("con1").innerHTML =
  `<i class="fab fa-youtube"></i>&nbsp; 20 Live class`;
document.getElementById("con3").innerHTML =
  `<i class="fas fa-clinic-medical"></i>&nbsp;04 QnA Class`;
document.getElementById("con4").innerHTML =
  `<i class="fas fa-question-circle"></i>&nbsp;04 Exams`;
document.getElementById("con5").innerHTML =
  `<i class="fas fa-calendar-check"></i>&nbsp;02 Practice Sheet`;
...
document.getElementById("con9").innerHTML =
  `<i class="fab fa-facebook-square"></i></i>&nbsp; ক্লাস শুরু জানুয়ারি ১৪, ২০২৩ (শনি,সোম,বুধ)`;
