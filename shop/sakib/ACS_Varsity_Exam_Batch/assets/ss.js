...
fetch(`https://${shopName2}/enrollment?productCode=${productCode}`)
    ...
    document.getElementById('con1').innerHTML = `<i class="fas fa-check-circle"></i>&nbsp; Paper final exam -8 `;
    document.getElementById('con4').innerHTML = `<i class="fas fa-check-circle"></i>&nbsp; Subject final -4`;
    document.getElementById('con5').innerHTML = `<i class="fas fa-check-circle"></i>&nbsp; Model test -10`;
