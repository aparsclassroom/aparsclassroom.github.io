...
fetch(
  `https://script.google.com/macros/s/AKfycbyzmc9PIPtS-jUU153RL8hBClSiVmbN_DufBumKEZ2ePZXPTGUF7UEGfG8z2Y94pyP6/exec?productCode=${productCode}`,
)
  .then((res) => {
    return res.json();
  })
