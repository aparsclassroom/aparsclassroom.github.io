...
fetch(
  `https://script.google.com/macros/s/AKfycbwtMPdak5swMkYJbfA0WzkmypaXDYTcQmG1LPrGoPc6nU8IsIw9N0OFIUdgBzqz1Gr1/exec?productCode=${productCode}`,
)
  .then((res) => {
    return res.json();
  })
  .then((data) => {
    ...
    document.getElementById("con1").innerHTML =
      `<i class="fas fa-check-circle"></i>&nbsp; একটি ক্লাসে তিনটি চ্যাপ্টার নয় বরং তিনটি ক্লাসে একটি চ্যাপ্টার`;
    document.getElementById("con4").innerHTML =
      `<i class="fas fa-check-circle"></i>&nbsp; Secret Shortcut Book PDF`;
    document.getElementById("con5").innerHTML =
      `<i class="fas fa-check-circle"></i>&nbsp; DU Question Bank PDF`;
    ...
    document.getElementById("con7").innerHTML =
      `<i class="fas fa-check-circle"></i>&nbsp; সপ্তাহে ৭ দিনই ক্লাস`;
