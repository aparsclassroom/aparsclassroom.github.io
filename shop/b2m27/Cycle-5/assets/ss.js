...
const product = "b2m27";
const product2 = "b2m27wbooks";
const productName = "ACS Physics HSC 27 By Apurbo Mashrur Apar";
const productName2 = "ACS Physics HSC 27 By Apurbo Mashrur Apar	with Books";
let productCode = "411";
let productCode2 = "448";
const fix = 1500;
const pls = 1000;
const pls2 = 1350;
const init = 0;
