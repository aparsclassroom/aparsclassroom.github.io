...
const tranx = "111" + Math.random().toString(36).substring(7) + new Date().getTime().toString().substring(7);
var tran;
$.get('https://www.uuidgenerator.net/api/version4', function(res) {
    document.getElementById('Tranx_ID').value = "BIO" + res.split("-")[4].substring(0, 16);
});
document.getElementById('Tranx_ID').value = tran;
// document.getElementById('Tranx_ID').value = tranx;
...
form.addEventListener('submit', e => {
    ...
    var raw = JSON.stringify({
        "tran_id": tran,
        "total_amount": document.getElementById('prs').value.trim(),
        "product": product,
    ...
    fetch("https://asg-shop.herokuapp.com/init", requestOptions)
        ...
        .then(result => {
            ...
            localStorage.setItem('BioMail', mail);
            localStorage.setItem('BioTranx', tranx);
