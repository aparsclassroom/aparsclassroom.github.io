    ...
    fetch('https://script.google.com/macros/s/AKfycbw4UrerGwUbMxJIthi-pgx_rApreJ6vsPW1FxiA05Ey6pq92i3LccYwS-GjBFwDzoLw/exec?Cupon=' + cpnCode.toUpperCase())
        ...
        .then((loadedData) => {
            if (loadedData.status === "success") {
                ...
                cupV.disabled = true;
                cpn.disabled = true;
                var perc = Math.round(((loadedData.Off + (fix - pls)) / fix) * 100);
                document.getElementById('how').style.display = "block";
                document.getElementById('how').innerHTML = `<span style="color:green;">${perc}%</span> discounted using <span style="color:blue;">${loadedData.Cupon}</span>`;
