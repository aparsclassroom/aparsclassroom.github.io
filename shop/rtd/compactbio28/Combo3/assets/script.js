...
const blockedCyclePurchaseChecks = [
    { cycle: "Cycle-1", products: ["753", "759"] },
    { cycle: "Cycle-2", products: ["754", "760"] },
    { cycle: "Cycle-3", products: ["755", "761"] },
    { cycle: "Cycle-4", products: ["756", "762"] },
    { cycle: "Cycle-5", products: ["757", "763"] },
    { cycle: "Cycle-6", products: ["758", "764"] }
];
...
firebase.auth().onAuthStateChanged(function(e) {
    if (e) {
        ...
        const purchaseChecks = [
            checkPurchase([productCode, productCode2, "765", "766", "768", "769"], e.uid),
