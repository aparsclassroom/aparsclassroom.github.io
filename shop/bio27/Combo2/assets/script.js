...
const blockedCyclePurchaseChecks = [
    { cycle: "Cycle-2", products: ["390", "433"] },
    { cycle: "Cycle-4", products: ["392", "435"] },
    { cycle: "Cycle-6", products: ["394", "437"] }
];
...
function getInvoiceUrl(purchase) {
    return purchase.invoices ? purchase.invoices[0].invoice : purchase.Invoice;
}
            ...
            .then(results => {
                ...
                if (existingPurchase) {
                    swal({
                        ...
                        return location.replace(getInvoiceUrl(existingPurchase))
                    })
                } else {
