...
const blockedCyclePurchaseChecks = [
    { cycle: "Cycle-1", products: ["774", "780"] },
    { cycle: "Cycle-2", products: ["775", "781"] },
    { cycle: "Cycle-3", products: ["776", "782"] },
    { cycle: "Cycle-4", products: ["777", "783"] },
    { cycle: "Cycle-5", products: ["778", "784"] },
    { cycle: "Cycle-6", products: ["779", "785"] }
];
...
firebase.auth().onAuthStateChanged(function(e) {
    if (e) {
        ...
        const purchaseChecks = [
            checkPurchase([productCode, productCode2, "786", "787", "789", "790"], e.uid),
