...
function testInfo(phoneNumberChk) {
  ...
  if (!OK) {
    document.getElementById("valid-feedback").innerHTML =
      '<span class="text-danger">Please Enter a Valid phone Number. <br>ex. +8801XXXXXXXXX</span>';
    document.getElementById("buy").disabled = true;
  } else {
    document.getElementById("valid-feedback").innerHTML =
      '<span class="text-success">✔ Valid Phone Number !</span>';
...
firebase.auth().onAuthStateChanged(function (e) {
  if (e) {
    ...
    const scriptURL =
      "https://script.google.com/macros/s/AKfycbwh7Pkvn7t_W-u0kuuEss9f3e_t52YkoeH9OgvuB3kpBEvDndAZHumBRxAFhwC3c_A/exec";
              ...
              .then((val) => {
                swal({
                  ...
                  return location.replace(
                    "https://www.facebook.com/groups/batch.protishruti.ac",
                  );
                });
              })
    ...
    document
      ...
      .addEventListener(
        "click",
        () => (location.href = "/shop/dashboard/login.html"),
      );
  }
});
