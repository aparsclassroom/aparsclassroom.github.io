const uploadURL =
  "https://script.google.com/macros/s/AKfycbxt4hJccE8qd9nbk_x62dwlsWSyY2_UID_y9yyKBMmqIRFXu3Q5UA0RvGsLWFtCDn9b-g/exec";
...
src.addEventListener("change", function () {
  ...
  fr.onload = (f) => {
    ...
    const url =
      "https://script.google.com/macros/s/AKfycbxBjIba8GIZVxeGnfk8ubBgFtjroXUtesjyzJAFFm4Kd1tr3PCnsLHelNaY_HWlUxXkpw/exec";
    ...
    fetch(`${url}?${qs}`, {
      ...
      .then((e) => {
        ...
        document.getElementById("newIn").src =
          "https://drive.google.com/file/d/" + e.fileId + "/preview";
        ...
        document.getElementById("immp").innerHTML =
          `<i class="fas fa-image"></i> Change this Powerpoint ?`;
...
function ValidateSize(file) {
  ...
  if (FileSize > 5) {
    alert(
      "This File size is " +
        FileSize.toFixed(2) +
        " MB which exceeds upload Limit of 5 MB and it will take too long to upload !\nPlease Compress the file 😶",
    );
    $(file).val("");
    return;
  }
