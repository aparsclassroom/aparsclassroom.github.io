...
const scriptURL = 'https://script.google.com/macros/s/AKfycbypyyZPFFC2Q0wPUE9CStX_A41QP2dhAAX-nVEHM-_KlUJDlMD8m7ENlyWzNFTSRIe8Rw/exec';
...
firebase.auth().onAuthStateChanged(function (e) {
    if (e) {
        ...
        document.getElementById('moda').innerHTML = 'Click here to Pre-Book <i class="fas fa-arrow-right"></i>';
