...
firebase.auth().onAuthStateChanged(function(e) {
    if (e) {
        ...
        document.getElementById('phone').value = t, document.getElementById('phones').value = t, document.getElementById("app").style.display = "none", document.getElementById("cup").style.display = "block"
