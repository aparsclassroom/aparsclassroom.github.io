...
fetch("https://shop.aparsclassroom.com/enrollment?productCode=531", requestOptions)
    .then(response => response.json())
    .then(result => {
        console.log('inside the enrollment fetch', result);
        document.getElementById('enrolled').setAttribute('countTo', result.count);
