        ...
        fetch(`https://${shopName}/${productCode}/purchase`, requestOptions)
            ...
            .then(result => {
                if (result.code === 200) {
                    ...
                    document.getElementById('meta').innerHTML = "যে ক্লাস্টারে এনরোল হতে চাও সিলেক্ট করো।";
                    document.getElementById('c1').href = "./Cluster-1/";
                    document.getElementById('c2').href = "javascript:locked()";
                    document.getElementById('c3').href = "javascript:locked()";
                    document.getElementById('c4').href = "javascript:locked()";
                    document.getElementById('c5').href = "javascript:locked()";
                    document.getElementById('c6').href = "javascript:locked()";
                }
            })
            .catch(() => {
                document.getElementById('meta').innerHTML = "যে ক্লাস্টারে এনরোল হতে চাও সিলেক্ট করো।";
