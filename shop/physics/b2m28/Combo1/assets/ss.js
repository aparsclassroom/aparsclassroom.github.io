...
const getAcsCampEnrollmentCount = () => {
    return fetch("https://api.acscamp.com/v1/products/sales-count", {
        ...
        body: JSON.stringify({
            productGroup: "phy28combo1",
            productCode: "1013",
            asgProductGroup: "b2m28combo1",
            asgProductCode: productCode,
        }),
    })
        .then((res) => res.json())
...
Promise.all([
    ...
    getEnrollmentCount("https://" + shopName2 + "/enrollment/?productCode=748"),
    getEnrollmentCount("https://" + shopName2 + "/enrollment/?productCode=751"),
