...
const blockedCyclePurchaseChecks = [
    { cycle: "Cycle-1", products: ["734", "740"] },
    { cycle: "Cycle-2", products: ["735", "741"] },
    { cycle: "Cycle-3", products: ["736", "742"] },
    { cycle: "Cycle-4", products: ["737", "743"] },
    { cycle: "Cycle-5", products: ["738", "744"] },
    { cycle: "Cycle-6", products: ["739", "745"] }
];
...
firebase.auth().onAuthStateChanged(function(e) {
    if (e) {
        ...
        const purchaseChecks = [
            checkPurchase([productCode, productCode2, "746", "747", "749", "750"], e.uid),
