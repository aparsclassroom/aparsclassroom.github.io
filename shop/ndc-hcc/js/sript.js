...
firebase.auth().onAuthStateChanged(function (e) {
  if (e) {
    ...
    form.addEventListener("submit", (em) => {
      ...
      fetch(
        `https://script.google.com/macros/s/AKfycbzw9BLtyB7hQzCYYV1ozyhX6w1n2HNXrsNkuDz7gtrfKS3XEZdoa15Nl_k4doux2d-6/exec`,
        {
          method: "POST",
        ...
        .then((data) => {
          swal({
            ...
            location.replace(
              "https://www.facebook.com/groups/1116571972397525/",
            );
          });
        })
