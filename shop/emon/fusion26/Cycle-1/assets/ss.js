...
document.getElementById("con1").innerHTML =
  `<i class="fab fa-youtube"></i>&nbsp; Basic Mathematics`;
document.getElementById("con3").innerHTML =
  `<i class="fas fa-clinic-medical"></i>&nbsp;ভৌতজগত ও পরিমাপ`;
document.getElementById("con4").innerHTML =
  `<i class="fas fa-question-circle"></i>&nbsp;ভেক্টর `;
document.getElementById("con5").innerHTML =
  `<i class="fas fa-calendar-check"></i>&nbsp;গতিবিদ্যা `;
