const product = "chem26Aloron";
const productName = "ACS HSC 26 chemistry by Mottasin Pahlovi";
const productCode = "364";
const fix = 1500;
const pls = 750;
const init = 0;
...
fetch(`https://${shopName2}/enrollment/${Cycle}?productCode=${productCode}`)
    ...
    document.getElementById('con3').innerHTML = `<i class="fas fa-clinic-medical"></i>&nbsp; শনি, সোম, বুধ ক্লাস`;
