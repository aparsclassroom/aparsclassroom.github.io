...
document.getElementById("con1").innerHTML =
  `<i class="fab fa-youtube"></i>&nbsp; 15+ Classes`;
document.getElementById("con3").innerHTML =
  `<i class="fas fa-clinic-medical"></i>&nbsp; 5+ Practice Sheets`;
document.getElementById("con4").innerHTML =
  `<i class="fas fa-question-circle"></i>&nbsp; 2 QnA Classes`;
document.getElementById("con5").innerHTML =
  `<i class="fas fa-calendar-check"></i>&nbsp; 2 Exams`;
