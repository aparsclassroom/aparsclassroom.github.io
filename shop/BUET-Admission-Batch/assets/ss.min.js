    ...
    fetch('https://script.google.com/macros/s/AKfycbwvF8jbq4w7f9smhmISRNgGsm94YUeibeXEYd9zDiuYYPrNHZ28_SHw_jh9xbmJ4Z7QyQ/exec?phone=' + search.value.trim())
        ...
        .then((loadedData) => {
            if (loadedData.data.Status != "enrolled") {
                fetch("https://script.google.com/macros/s/AKfycbwbDgncD1Be8JF_yWPV6CmaNOuJbtw_ZI8nMp8GTYlGsMH2fVOkrrtDnjG-T3hHimYL9Q/exec?q=stat&uid=" + loadedData.data.phone + "&product=" + product)
                    .then(response => {
