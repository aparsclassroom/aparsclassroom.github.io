...
firebase.auth().onAuthStateChanged(function(e) {
    if (e) {
        ...
        var comboRaw = JSON.stringify({
            "products": [comboProductCode],
            'uid': e.uid
        });
        ...
        Promise.allSettled([
            ...
            fetch(`https://${shopName2}/v3/purchase/multiple`, comboRequestOptions).then(response => response.json())
        ])
            .then(results => {
