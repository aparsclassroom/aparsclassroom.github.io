...
fetch(
  `https://script.google.com/macros/s/AKfycbzVbICTE8cclbEYfhYS0Ae4UkfezAhtc2bSqOMGj1Gy_k9janPcSWp3am9RoQ3tyBCA/exec?productCode=${productCode}`,
)
  .then((res) => {
    return res.json();
  })
  .then((data) => {
    ...
    document.getElementById("con2").innerHTML =
      `<i class="fas fa-clipboard"></i>&nbsp; ${types[1].TotalClasses} ${types[1].ContType} `;
    ...
    document.getElementById("con6").innerHTML =
      `<i class="fas fa-user-graduate"></i>&nbsp;${types[5].TotalClasses} ${types[5].ContType} `;
    document.getElementById("duration").innerHTML =
      `${types[7].TotalClasses} মাস`;
    document.getElementById("con7").innerHTML =
      `<i class="fas fa-tablet-alt"></i>&nbsp; Dedicated Web App`;
    document.getElementById("con8").innerHTML =
