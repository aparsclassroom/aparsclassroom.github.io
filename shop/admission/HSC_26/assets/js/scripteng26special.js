...
//     document.getElementById('price').value = pls2;
//     document.getElementById('nop').innerText = pls2 + "৳";
//     document.getElementById('couponinfocenter').style.display = 'none'; // Show the books checkbox
//     document.getElementById('couponinfocenter2').style.display = 'block'; // Show the books checkbox
...
//         document.getElementById('nop').innerText = pls2 + "৳";
//         productcode = productCode2;
//         document.getElementById('couponinfocenter').style.display = 'none'; // Hide the normal coupon info
//         document.getElementById('couponinfocenter2').style.display = 'block'; // Show books coupon info
//         shippingInputs.forEach(input => input.setAttribute('required', ''));
...
//                 document.getElementById('nop').innerText = pls + "৳";
//                 productcode = productCode;
//                 document.getElementById('couponinfocenter').style.display = 'block'; // Hide the books checkbox
//                 document.getElementById('couponinfocenter2').style.display = 'none'; // Show the books checkbox
//                 shippingInputs.forEach(input => input.removeAttribute('required'));
//             } else {
...
//                 document.getElementById('addbooksdiv').style.display = "none";
//                 var nes = isShipping ? pls2 - loadedData.Off : pls - loadedData.Off;
...
firebase.auth().onAuthStateChanged(function(e) {
    if (e) {
        ...
        myHeaders.append("Content-Type", "application/json");
        var raw = JSON.stringify({
            "products": [productCode, productCode2, productCode3, productCode4, productCode5, productCode6],
            'uid': e.uid
        });
